...
function AddRestPlayers() {
    for (let i = 0; i < MaleArray.length; i++) {
        if (!checkspanValExist(MaleArray[i])) {
            PlayerNum++;
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(MaleArray[i]) + '</span></li>';
            var el = $(str);
    ...
    for (let i = 0; i < FemaleArray.length; i++) {
        if (!checkspanValExist(FemaleArray[i])) {
            PlayerNum++;
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(FemaleArray[i]) + '</span></li>';
            var el = $(str);
            $('#Restgrouped').append(el);
            $('#Restgrouped button').css('width', ViewPlayersbutton);
            $('#Restgrouped button').css('font-size', ViewPlayersbuttonFontSize);
    ...
    for (let i = 0; i < VIPArray.length; i++) {
        if (!checkspanValExist(VIPArray[i])) {
            PlayerNum++;
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(VIPArray[i]) + '</span></li>';
            var el = $(str);
            $('#Restgrouped').append(el);
            $('#Restgrouped button').css('width', ViewPlayersbutton);
            $('#Restgrouped button').css('font-size', ViewPlayersbuttonFontSize);
...
function AddPlayers() {
    for (let i = 0; i < Court1Array.length; i++) {
        ...
        if (McheckspanValExist(Court1Array[i])) {
            ///是隊員 男隊員|女隊員|VIP
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(Court1Array[i]) + '</span></li>';
        } else {
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:gold" class="sortHandle">' + (String)(Court1Array[i]) + '</span></li>';
        }
        var el = $(str);
        $('#Court1').append(el);
    ...
    for (let i = 0; i < Court2Array.length; i++) {
        ...
        if (McheckspanValExist(Court2Array[i])) {
            ///是隊員 男隊員|女隊員|VIP
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(Court2Array[i]) + '</span></li>';
        } else {
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:gold" class="sortHandle">' + (String)(Court2Array[i]) + '</span></li>';
        }
        var el = $(str);
        $('#Court2').append(el);
    ...
    for (let i = 0; i < Court3Array.length; i++) {
        ...
        if (McheckspanValExist(Court3Array[i])) {
            ///是隊員 男隊員|女隊員|VIP
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(Court3Array[i]) + '</span></li>';
        } else {
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:gold" class="sortHandle">' + (String)(Court3Array[i]) + '</span></li>';
        }
        var el = $(str);
        $('#Court3').append(el);
    ...
    for (let i = 0; i < Court4Array.length; i++) {
        ...
        if (McheckspanValExist(Court4Array[i])) {
            ///是隊員 男隊員|女隊員|VIP
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(Court4Array[i]) + '</span></li>';
        } else {
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:gold" class="sortHandle">' + (String)(Court4Array[i]) + '</span></li>';
        }
        var el = $(str);
        $('#Court4').append(el);
    ...
    for (let i = 0; i < WaitArray.length; i++) {
        ...
        if (McheckspanValExist(WaitArray[i])) {
            ///是隊員 男隊員|女隊員|VIP
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(WaitArray[i]) + '</span></li>';
        } else {
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:gold" class="sortHandle">' + (String)(WaitArray[i]) + '</span></li>';
        }
        var el = $(str);
    ...
    for (let i = 0; i < RestArray.length; i++) {
        ...
        if (McheckspanValExist(RestArray[i])) {
            ///是隊員 男隊員|女隊員|VIP
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:" class="sortHandle">' + (String)(RestArray[i]) + '</span></li>';
        } else {
            str = '<li class="p' + (String)(PlayerNum) + '"><input id="InputName' + (String)(PlayerNum) + '" type="text"><button class="Name">改名</button><span style="background-color:gold" class="sortHandle">' + (String)(RestArray[i]) + '</span></li>';
        }
        var el = $(str);
        $('#Restgrouped').append(el);
        $('#Restgrouped button').css('width', ViewPlayersbutton);
